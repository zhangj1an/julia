        ...
        if (ty) {
            ...
            if (cache->tname != jl_emptysvec) {
                ...
                if (name && !jl_is_typevar(typetype)) {
                    ...
                    // TODO: the possibility of encountering `Type{Union{}}` in
                    // this intersection forces us to do substantial extra work
                    // when we see a typevar here, even though the likelyhood
                    // of that occuring is frequently zero
